...
class TestTaskModel:
    def test_create_task(self, create_default_user) -> None:
        task_instance = Task(
                task = "Estudar Flask",
    ...
    def test_task_string_representation(self, create_default_user) -> None:
        task_instance = Task(
                task = "Estudar Flask",
                task_description = "Estudar o framework Flask para desenvolver aplicações web",
                task_conclusion = False,
    ...
    def test_get_task_name_and_description(self, create_default_user) -> None:
        task_instance = Task(
            task = "asd",
    ...
    def test_modify_task_name_and_description(self, create_default_user) -> None:
        task_instance = Task(
            task = "Estudar Flask",
            task_description = "Estudar o framework Flask para desenvolver aplicações web",
            task_conclusion = False,
    ...
    def test_toggle_task_conclusion_status(self, create_default_user) -> None:
        task_instance = Task(
            task = "Estudar Flask",
            task_description = "Estudar o framework Flask para desenvolver aplicações web",
            task_conclusion = False,
